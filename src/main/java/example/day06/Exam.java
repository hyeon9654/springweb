...
public class Exam {
    public static void main(String[] args) {
        ...
        // t 변수가 참조하는 값은 몇개인가요? 1개(1개), t -> Test(101번지) -> name(201번지)
        ...
        Board b1 = new Board( 1, "제목1", c1);
            ...
            // *] JPA 개발자는 이 구조 --> db 연관관계(join) 사용 가능하겠다. 단방향참조
            // *] c1 통해 b1(참조)알 수 있나요? 아니요, 왜? category가  없으니까
            // *] JPA 개발자는
        ...
        // System.out.println( b1 );
            ...
            // 결론: jpa에서는 양방햐으 db는 양방향 없다.
            // 실수에서는 양방향 비권장, 불필요한 자료들까지 불러오니까.
