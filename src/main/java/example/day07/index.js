...
else{ console.log('C학점') }    // 그 외 C학점
// 3-2 : 삼항연산자,    조건? 참 : 거잣,        조건1 ? 참1 : 조건2 ? 참2 거짓
...
// 6-2 : [ 값, 값, 값 ]
const obj2 = [ '유재석' , 40 , (param) => { } ]     // 인덱스로 속성값 호출
...
// 10. 동기식: 먼저 호출한 함수/기능이 결과가 올떄까지 대기상태 ,
